...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally( () => {
        // Lưu ý về việc setLoading về false luôn phải chạy trong Finally để dù có lỗi hay 0 thì cũng 0 hiện cái loading nữa.
        setLoading(false)
      })
  }
  // Bọc hàm handleInputSearchChange ở trên vào useDebounceFn và cho delay khoảng 1s sau khi dừng gõ phím thì mới chạy cái func
