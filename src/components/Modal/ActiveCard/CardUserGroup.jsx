...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Lấy ra thông tin thành viên trong board thông qua FE_allUsers
  ...
  const handleUpdateCardMembers = (user) => {
    // Tạo một biến incomingMemberInfo để gửi cho BE, với 2 thông tin chính là userId và action là xóa khỏi card hoặc thêm vào card
